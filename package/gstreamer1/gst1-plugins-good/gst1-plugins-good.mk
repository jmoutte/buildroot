...
GST1_PLUGINS_GOOD_VERSION = 1.3.1
...
GST1_PLUGINS_GOOD_AUTORECONF_OPT = -I $(@D)/m4 -I $(@D)/common/m4

GST1_PLUGINS_GOOD_POST_DOWNLOAD_HOOKS += GSTREAMER1_COMMON_DOWNLOAD
...
GST1_PLUGINS_GOOD_DEPENDENCIES += v4l-utils
